...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OMOS Technologies | Cybersecurity Training" },
      {
        name: "description",
        content: "Comprehensive cybersecurity training programs. Admission in progress.",
      },
      { name: "author", content: "OMOS Technologies" },
